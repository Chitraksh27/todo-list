...
function Todo() {
    ...
    useEffect(() => {
        axios.get('http://127.0.0.1:5175/getTodoList')
            .then(result => {
    ...
    const addTask = (e) => {
        ...
        axios.post('http://127.0.0.1:5175/addTodoList', { task: newTask, status: newStatus, deadline: newDeadline })
            .then(res => {
                console.log(res);
    ...
    const saveEditedTask = (id) => {
        ...
        axios.post('http://127.0.0.1:5175/updateTodoList/' + id, editedData)
            .then(result => {
                console.log(result);
                setEditableId(null);
                setEditedTask("");
    ...
    const deleteTask = (id) => {
        axios.delete('http://127.0.0.1:5175/deleteTodoList/' + id)
            .then(result => {
                console.log(result);
                window.location.reload();
            })
